...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kwvlg4w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kwvlg4w.containers.anotherwebservice.com/
...
```
git clone git@github.com:andreypleshakov/container-kwvlg4w.git
cd container-kwvlg4w
```
...
```
docker attach container-kwvlg4w
```
